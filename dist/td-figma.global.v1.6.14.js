/* TD_Figma_All_Pages_Core_Style_GTM_v1.8.8.html */
(function(){window.TDFigmaStyleReady=window.TDFigmaStyleReady||{};window.TDFigmaStyleReady.allPages="1.8.7";}());
...
/* TD_Figma_All_Pages_Navigation_GTM_v5.5.0.html */
(function () {
  'use strict';

  var job = {
    key: 'td-figma-navigation-v550',
    ready: function () {
    ...
    start: function () {
      (function () {
        ...
        function contactMarkup(mobile) {
          ...
          html.push(
            '<div class="tdff-v1-service-intro">' +
            '<div class="tdff-v1-service-title">' +
            '服務時間' +
            '</div>' +
            '<p class="tdff-v1-service-message">' +
        ...
        function ensureFooter() {
          ...
          if (
            root &&
            root.getAttribute('data-tdff-version') !== VERSION
          ) {
            if (root.parentNode) {
